...
1. Get an **invite code** from your school administrator
2. Go to [studypl.us](https://studypl.us) and click **Sign Up**
3. Enter your invite code and account details
4. Verify your email address

### Can I change my email address?

Yes, go to **Settings** → **Account** to update your email. You'll need to verify the new email address.

### Can I login with Google?

Yes! You can use **Login with Google** on the login page. If you already have an account, you can link Google in **Settings** → **Binding**.
...
- Check if you're enrolled in the course on eClass

### What data syncs from eClass?

- Homework assignments (current and history)
- Info/notices (non-submission items)
- Calendar events
- Your eClass profile information
...
### How does the AI To-Do Generator work?
...
### How do I disconnect eClass?

Go to **Settings** → **Binding** → **eClass** and click **Disconnect**. Your stored credentials will be deleted.
